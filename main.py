...
async def query_fallback_ai(questions: List[str], documents: List[Dict]) -> str:
    ...
    "Include relevant statistics from the documents along with numerical figures wherever possible Example 30 instead of thirty. "
    ...
    "Yes, the policy covers maternity expenses including childbirth and lawful medical termination of pregnancy, with a waiting period of 24 months and a limit of two claims.\n\n"
